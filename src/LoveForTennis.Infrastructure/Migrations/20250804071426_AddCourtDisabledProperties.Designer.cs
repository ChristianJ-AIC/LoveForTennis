...
namespace LoveForTennis.Infrastructure.Migrations
{
    ...
    [Migration("20250804071426_AddCourtDisabledProperties")]
    partial class AddCourtDisabledProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoveForTennis.Core.Entities.Court", b =>
                {
                    ...
                    b.Property<string>("IsDisabledByUser")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<DateTime?>("IsDisabledFrom")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("IsDisabledTo")
                        .HasColumnType("datetime2");
